    ...
    <div className="App">
      <div className="hero">
        <nav>
          ...
          <div className="links">
            <a href="http://x.com/mascotele">
              <img src={twitter} alt="" />
            </a>
            <a href="https://t.me/REPUBLICANMASCOTELE">
      ...
      <div className="supply">
        ...
        <p>
          Meet the iconic elephant $ELE the official mascot for Donald Trump's Republican party! Since 1874 the elephant has represented the Republican Party and in 2024 it's time to MAGA by leading the charge!
        </p>
      ...
      <div className="about">
        ...
        <div className="con">
          <div className="left">
            ...
            <ul>
              <li>
              Not only will we Make America Great Again, we're gonna Make America Wealthy Again.
              </li>
            </ul>
            <a href="/" className="btn">
              <img src={buy} alt="" />
      ...
      <footer>
        ...
        <p>REPUBLICAN MASCOT © 2024. All Rights Reserved.</p>
      </footer>
    </div>
  );
}
